...
public:
  struct Config {
    ...
    float reactionTime = 0.1f;             // Delay in response to track changes
    float maxSpeed = 1.0f;                 // Multiplier for maximum speed (0-1)
    float brakingSkill = 1.0f;            // How well the AI brakes for turns (0-1)
    float racingLine = 1.0f;              // How well the AI follows optimal racing line (0-1)
  };
